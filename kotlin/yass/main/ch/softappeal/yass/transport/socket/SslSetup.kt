...
class SslSetup @JvmOverloads constructor(
    ...
    internal val context: SSLContext
...
fun SslSetup.socketFactory() = object : AbstractSocketFactory() {
...
fun SslSetup.serverSocketFactory() = object : AbstractServerSocketFactory() {
